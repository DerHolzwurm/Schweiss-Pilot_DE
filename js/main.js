...
import { initMachineParameters } from './features/machine-parameters.js';
...
async function init() {
  ...
  initMachineParameters(app.devices, app.welding.manufacturerDatabase, app.welding.sourceDatabase);
