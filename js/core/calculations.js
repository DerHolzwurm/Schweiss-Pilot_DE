...
export function calculateWelding(input, data, feedbackTrim = 0) {
  ...
  const fase = thickness < 4
    ? 'Keine Fase nötig, Kanten sauber vorbereiten.'
    : thickness < 6
      ? 'Leichte Fase prüfen; besonders bei Stumpfnähten.'
      : thickness < 8
        ? 'Fase empfohlen; sauberen Wurzelbereich sicherstellen.'
        : 'Fase und mehrlagiges Arbeiten einplanen.';
